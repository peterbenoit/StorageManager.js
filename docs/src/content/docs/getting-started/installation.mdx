...
```html
<!-- Replace x.y.z with the desired version -->
<script src="https://unpkg.com/web-storage-manager-js@x.y.z/StorageManager.js"></script>
...
<script src="https://unpkg.com/web-storage-manager-js/StorageManager.js"></script>
```
